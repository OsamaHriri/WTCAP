...
mydb1 = myclient["arabic_semantic_labeling"]
mycol = mydb1["poems"]
poetsCollections = mydb1["poets"]
...
mongo_poets = list(poetsCollections.find({}, {"_id": 0, "info": 0, "place": 0, "whoAdded": 0, "period": 0}))
...
poetsCollections.insert_many(poets)
